  ...
  return (
    ...
    <header class="text-center">
      ...
      <ul class="list-unstyled contact-info">
        <li><i class="bi bi-phone"></i> 901-659-2413</li>
        <li><i class="bi bi-envelope"></i>  yashraw111@gmail.com</li>
        <li><i class="bi bi-geo-alt"></i> Vastral, Ahmedabad</li>
        <li><i class="bi bi-github"></i> <a className="text-decoration-none text-dark" href="https://github.com/yashraw111">github.com/yashpanchal</a></li>
      </ul>
    </header>
    <section>
      <h2 class="section-title">Profile Summary</h2>
      <p>
      A dedicated web developer with a strong foundation in HTML, CSS, JavaScript,
and React.js. Currently advancing skills through a Full Stack Development
course at Red & White Multimedia. Passionate about building responsive, userfriendly web applications and eager to contribute effectively to dynamic and
...
{/* 
    ...
    <section>
      ...
      <p><strong>Higher Secondary School Certificate</strong></p>
    ...
    <section>
      ...
      <ul>
        <li><strong>Frontend Technologies:</strong> React JS, JavaScript, Bootstrap, HTML/CSS, jQuery</li>
        <li><strong>Version Control:</strong> Git & GitHub</li>
        <li><strong>Languages:</strong> Gujarati (Fluent), Hindi (Fluent), English (Intermediate)</li>
        <li><strong>Soft Skills:</strong> Leadership, Teamwork, Problem Solving, Project Management</li>
      </ul>
    </section>
    ...
    <section>
      ...
      <ul>
        <li>Developed a fully functional e-commerce platform with features like product listing, shopping cart, user authentication, and order management.</li>
      ...
      <ul>
        <li>Developed a full-fledged system with CRUD operations for user profiles using React, Axios, and Redux Toolkit.</li>
      </ul>
    </section>
    ...
    <section>
      ...
      <ul>
        <li>Runner-up in TechWar 2024 - CSS Master Competition at Red & White Multimedia Education.</li>
      </ul>
    </section>
